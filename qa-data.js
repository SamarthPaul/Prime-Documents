...
window.QA_DATA = {
  ...
  'market_research_module.html': {
    ...
    rows: [
      ...
      { t:'Log Book', s:'Activities', e:'Log table (wireframe Task Log)', ty:'table', w:'Log Book tab', p:'Y', v:'N', fn:'N', sev:'major', fe:'task + date + notes', be:'log child table', n:'BLOCKED by Bug 124: Log Book save fails - DF Market Research not found in the Diagnostic Framework field (recurring self-rejecting validation). Now confirmed on 5 frameworks (Branding, Market Research, Schemes, Business Registration, Product Compliance). Log Book component proven on 13 other frameworks.' }
    ]
  },
