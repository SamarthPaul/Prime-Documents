...
window.QA_DATA = {
  ...
  'financials_module.html': {
    ...
    rows: [
      ...
      { t:'Resources', s:'Reference Materials', e:'Resources tab (build addition; wireframe has no Resources tab for Financials)', ty:'table', w:'Resources tab', p:'Y', v:'Y', fn:'VERIFIED via shared upload component (proven end-to-end on Standardization: + Upload → Upload Resource modal [file + Category + Title* + Description] → persists & shows with Open↗ / View). Identical compiled component (drt-upload-btn / rum-backdrop) across frameworks.', sev:'', fe:'n/a (not in wireframe)', be:'BRD standard Resources pattern', n:'Build enhancement; not yet driven — to verify CRUD.' },
