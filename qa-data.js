...
window.QA_DATA = {
  ...
  'branding_identity_module.html': {
    ...
    rows: [
      ...
      { t:'Log Book', s:'Activities', e:'Log table (wireframe Task Log)', ty:'table', w:'Log Book tab', p:'Y', v:'N', fn:'N', sev:'major', fe:'task + date + notes', be:'log child table', n:'BLOCKED by Bug 124: Log Book save fails - DF Branding Identity was not found in the Diagnostic Framework field (hidden log-row field rejects its own auto-filled value). Now confirmed on 6 frameworks (Branding, Market Research, Schemes, Business Registration, Product Compliance, Product Prototyping). Log Book component itself proven on 16+ other frameworks (incl. Standardization, BPC, Quality Control, Pitch Deck, Infrastructure, Unit Pricing - all driven literally).' }
    ]
  },
  ...
  'market_research_module.html': {
    ...
    rows: [
      ...
      { t:'Log Book', s:'Activities', e:'Log table (wireframe Task Log)', ty:'table', w:'Log Book tab', p:'Y', v:'N', fn:'N', sev:'major', fe:'task + date + notes', be:'log child table', n:'BLOCKED by Bug 124: Log Book save fails - DF Market Research not found in the Diagnostic Framework field (recurring self-rejecting validation). Now confirmed on 6 frameworks (Branding, Market Research, Schemes, Business Registration, Product Compliance, Product Prototyping). Log Book component proven on 16+ other frameworks (all driven literally).' }
    ]
  },
  ...
  'product_prototyping_module.html': {
    ...
    rows: [
      ...
      { t:'Log Book', s:'Activities', e:'Log table (wireframe Task Log)', ty:'table', w:'Log Book tab', p:'Y', v:'N', fn:'N', sev:'major', fe:'task + date + notes', be:'log child table', n:'Log Book BLOCKED by Bug 124 on DF-PROTO-EP-00026-00001: save fails DF Product Prototyping was not found in the Diagnostic Framework field (6th affected framework with Branding, Market Research, Schemes, Business Registration, Product Compliance). Resources upload itself works (QA Reference Material PNG persisted). Log row removed to let resource save.' }
    ]
  },
  ...
  'product_standardization_module.html': {
    ...
    rows: [
      ...
      { t:'Log Book', s:'Activities', e:'Log table (wireframe Task Log)', ty:'table', w:'Log Book tab', p:'Y', v:'Y', fn:'Y', sev:'', fe:'task + date + notes', be:'log child table', n:'DRIVEN literally (reference framework): + Add Row Log Date/Hours/Task/Activity Type/Comments -> persists to log child table. This is the framework the Log Book component was first proven on.' }
    ]
  },
  ...
  'quality_control_module.html': {
    ...
    rows: [
      ...
      { t:'Log Book', s:'Activities', e:'Log table (wireframe Task Log)', ty:'table', w:'Log Book tab', p:'Y', v:'Y', fn:'Y', sev:'', fe:'task + date + notes', be:'log child table', n:'DRIVEN literally on QC-EP-00026-00001: + Add Row Log Date/Hours/Activity Type/Comments -> Save -> clean (no Bug 124). Resources + Upload also driven (QA Reference Material PNG, Open arrow).' }
    ]
  },
  ...
  'business_plan_canvas_module.html': {
    ...
    rows: [
      ...
      { t:'Log Book', s:'Activities', e:'Log table (wireframe Task Log)', ty:'table', w:'Log Book tab', p:'Y', v:'Y', fn:'Y', sev:'', fe:'task + date + notes', be:'log child table', n:'DRIVEN literally on BPC-EP-00026-00001: + Add Row Log Date/Hours/Activity Type=Field Visit/Comments -> Save -> persisted (log_table 1 row, confirmed via API). NOT affected by Bug 124. Resources + Upload also driven (QA Reference Material PNG, Open arrow).' }
    ]
  },
  ...
  'infrastructure_module.html': {
    ...
    rows: [
      ...
      { t:'Resources', s:'Reference Materials', e:'Resources table + Add Resource', ty:'table', w:'Resources tab', p:'Y', v:'Y', fn:'Y', sev:'', fe:'rows + upload', be:'Resources child table', n:'VERIFIED via shared upload component (proven end-to-end on Standardization: + Upload → Upload Resource modal [file + Category + Title* + Description] → persists & shows with Open↗ / View). Identical compiled component (drt-upload-btn / rum-backdrop) across frameworks.' },
      { t:'Log Book', s:'Activities', e:'Log table (wireframe Task Log)', ty:'table', w:'Log Book tab', p:'Y', v:'Y', fn:'Y', sev:'', fe:'task + date + notes', be:'log child table', n:'DRIVEN literally on INF-EP-00026-00001: + Add Row Field Visit + hours + comments -> Save -> clean (no Bug 124). Resources + Upload also driven (QA Reference Material PNG, Open arrow). Note: Infra financial-model summary remains blocked = Bug 119 (separate).' }
    ]
  },
  ...
  'unit_pricing_module.html': {
    ...
    rows: [
      ...
      { t:'Resources', s:'Reference Materials', e:'Resources table + Add Resource', ty:'table', w:'Resources tab', p:'Y', v:'Y', fn:'Y', sev:'', fe:'rows + upload', be:'Resources child table', n:'VERIFIED via shared upload component (proven end-to-end on Standardization: + Upload → Upload Resource modal [file + Category + Title* + Description] → persists & shows with Open↗ / View). Identical compiled component (drt-upload-btn / rum-backdrop) across frameworks.' },
      { t:'Log Book', s:'Activities', e:'Log table (wireframe Task Log)', ty:'table', w:'Log Book tab', p:'Y', v:'Y', fn:'Y', sev:'', fe:'task + date + notes', be:'log child table', n:'DRIVEN literally on UP-EP-00026-00001: + Add Row Field Visit + hours + comments -> Save -> clean (no Bug 124). Resources + Upload also driven (QA Reference Material PNG, Open arrow). Note: cross-framework auto-fetch remains = Bug 120 (separate).' }
    ]
  }
